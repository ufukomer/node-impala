  ...
  _createClass(ImpalaClient, [{
    ...
    value: function connect() {
      ...
      connection.on('connect', function () {
        return deferred.resolve('Connection is established.');
      });
...
ImpalaClient.getObjSize = function (obj) {
  var count = 0;
...
ImpalaClient.isObjEmpty = function (obj) {
  return !ImpalaClient.getObjSize(obj) > 0;
};
